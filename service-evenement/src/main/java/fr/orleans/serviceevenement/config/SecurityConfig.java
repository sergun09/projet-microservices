...
import fr.orleans.serviceevenement.dtos.ConsulDTO;
...
public class SecurityConfig {
    ...
    @Bean
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception { // erreur que tout le monde a
        http
